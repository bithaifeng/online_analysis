...
g++ -std=c++11 trace_collect.c lightswapinterface.c lt_profile.c evict.c prefetch_mine.c page_table.c memory_manage.c rrip.c -w -g -o trace_collect -O2 -lpthread -fpermissive -mcmodel=medium
